...
export class AuthController {
  ...
  @Get('/validate') // Look into this part of the code. Figuree out why the flow for the first time user does not redirect to the onboarding UI like it should and instead just redirects to the dashboard
  ...
  getUserCommits(@Req() request: Request) {
    if (!request.user) {
